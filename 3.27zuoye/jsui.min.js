		...
		function() { var t = {};
			...
			_tabKeydown: function(t) { var i = e(this.document[0].activeElement).closest("li"),
					...
					n = !0; if(!this._handlePageNav(t)) { switch(t.keyCode) {
						...
						default:
							return } t.preventDefault(), clearTimeout(this.activating), s = this._focusNextTab(s, n), t.ctrlKey || t.metaKey || (i.attr("aria-selected", "false"), this.tabs.eq(s).attr("aria-selected", "true"), this.activating = this._delay(function() { this.option("active", s) }, this.delay)) } },
